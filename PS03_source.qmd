...
#na.rm = TRUE : if theres any missing (NA) datapoints in the dataset, 
#it wont cause final calc to return NA.
...
#inline code answer: - In January of 2015, `r fewest_listings$city` had the fewest houses 
#listed for sale with a total of `r fewest_listings$listings` houses listed.
```
...
#inline code answer: - The most houses were sold In Texas during month `r sales_2012$month[1]` (June), 
#with a total of `r format(sales_2012$total_sales[1], big.mark = ",")` houses sold.
```
